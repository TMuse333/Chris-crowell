...
const BlockInTextCard = ({
  ...
  return (
    <div className="w-full max-w-xl space-y-6">
      ...
      <button className=" rounded-full border border-white p-3 text-lg sm:text-border-3 font-medium transition-colors hover:bg-neutral-950 hover:text-neutral-100
      mr-4">
        Contact
      </button>
      </Link>
