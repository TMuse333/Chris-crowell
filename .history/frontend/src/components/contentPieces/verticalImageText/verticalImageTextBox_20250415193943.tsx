...
const VerticalImageTextBox:React.FC<Props> = ({
  ...
  style={{
   ...
   >{description}</motion.p>
          ...
          <div className="p-6 border mt-12 rounded-lg shadow-md bg-white text-black">
      <h2 className="text-xl font-bold mb-2">Subscribe to Our Newsletter</h2>
      <p className="mb-4">Stay up-to-date with the Halifax real estate market and helpful tips!</p>
      <motion.a
        href="http://eepurl.com/iX8DwA"
        target="_blank"
        ...
        className="inline-block px-5 py-2 rounded-md bg-blue-500 text-white text-center font-medium hover:bg-blue-600"
      >
        Subscribe Now
      </motion.a>
    </div>
