    ...
    return (
        <>
            <motion.section
                ref={ref}
                style={{ scale,  }}
                className={`relative mx-auto w-[98vw] rounded-2xl 
              opacity-1 my-8 max-w-[1200px] text-black
              border border-[#00bfff] border-4
              bg-gradient-to-b from-blue-200 to-blue-[#B1D3FF]
            ...
            >
                ...
                id={`${title}-header`}
                    ...
                    translate-y-[-2rem] opacity-0 px-3 font-cursive"
                >
                    {title}
                </h2>
                <section className={`flex flex-col md:px-4 mx-auto ${reverse ? 'md:flex-row-reverse' : 'md:flex-row'}`}>
                    ...
                    ref={imageRef}
                        ...
                        width={600}
                        height={1300}
                        className='w-[80vw] mx-auto mb-4 md:w-[50vw] max-w-[500px] rounded-2xl
                    ...
                    >
                        ...
                        <button className="bg-button-color
                        p-2 rounded-2xl mt-3 hover:text-black
                        hover:bg-white text-white transition-all">
                ...
                pb-8 w-full justify-around ">
                    {aspects.map((aspect, index) => (
                        <motion.li className="mb-4 w-[90%] max-w-[250px] mx-auto p-3 neutral-gradient-bg border border-gray-200 border-4 rounded-2xl flex justify-center items-center text-center md:w-full md:mr-4"
                            key={index}
