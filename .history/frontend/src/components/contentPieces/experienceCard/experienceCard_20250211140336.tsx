            ...
            >
                ...
                pb-8 w-full justify-around ">
                    {aspects.map((aspect, index) => (
                        <motion.li className="mb-4 w-[90%] max-w-[250px] mx-auto p-3 neutral-gradient-bg border border- border-4 rounded-2xl flex justify-center items-center text-center md:w-full md:mr-4"
                            key={index}
