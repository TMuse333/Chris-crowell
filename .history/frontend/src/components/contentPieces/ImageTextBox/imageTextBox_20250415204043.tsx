...
<motion.div
 ...
 animate={imgInView ? 'animate' : 'initial'}>
      ...
      <div className="w-screen md:w-[45vw] pr-4 md:pr-0">
        ...
        className="hidden sm:block text-left pl-5 sm:pl-12 pt-5 sm:text-4xl font-semibold text-3xl pr-3
        font-cursive">
          {title}
        </motion.h2>
        ...
        ref={pRef}
         ...
         >
          ...
          <motion.button
  className="mt-6 p-3 rounded-xl text-white bg-[#0077b3] hover:bg-blue-800 "
