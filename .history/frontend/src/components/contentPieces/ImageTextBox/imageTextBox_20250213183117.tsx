        ...
        ref={pRef}
         ...
         >
          ...
          <Link href={buttonLink}>
            <motion.button className="mt-6 bg-gradient-to-br from-blue-400 to-blue-300 hover:bg-gradient-to-br from-blue-400 to-blue-300 p-3 rounded-xl hover:bg-white hover:text-[#a8865e] text-gray-200 transition-colors "
