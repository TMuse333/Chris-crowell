...
const imageFadeIn = (delay:number) => {
  ...
  return (
    ...
    <section
      className={`flex flex-col justify-center items-center pt-8 pb-8 relative mx-auto max-w-[1200px] ${
...
<motion.div
 ...
 animate={imgInView ? 'animate' : 'initial'}>
      ...
      width={600}
      height={1300}
        className="rounded-xl relative md:w-[50vw] w-[90vw] h-[80vh] md:h-[55vw] max-h-[567px] max-w-[668px] mx-auto object-cover"
        src={src}
        alt={alt || "Image"}
      />
      </motion.div>
      ...
      <div className="w-screen md:w-[45vw] pr-4 md:pr-0">
        ...
        className="hidden md:block text-left pl-5 sm:pl-12 pt-5 sm:text-4xl font-semibold text-red text-3xl pr-3
        font-cursive">
          {title}
        </motion.h2>
        ...
        ref={pRef}
         ...
         >
          ...
          <Link href={buttonLink}>
            <motion.button className="mt-6 bg-button-color p-3 rounded-xl hover:bg-white hover:text-[#a8865e] text-gray-200 transition-colors "
