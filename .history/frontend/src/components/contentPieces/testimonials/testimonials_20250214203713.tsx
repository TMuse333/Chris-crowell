...
const testimonialsData = [
    ...
    {
        title: 'Satisfied Customer',
        quote: `"After I was diagnosed with cancer, my house was damaged in a fire. With so much going on, selling my home felt impossible. Ontario Cash for Houses came through for me, purchasing my home quickly and lifting a huge burden from my shoulders. Their kindness and professionalism gave me peace of mind during one of the hardest times in my life.`,
        author: 'A. Johnson',
  ...
  const prevTestimonial = () => {
    ...
    return (
        <section className='bg-gradient-to-b from-gray-600 via-gray-600 to-gray-400 border border-white ml-auto mr-auto max-w-[1200px] w-screen 
         ...
         h-[550px] sm:w-[90vw]
        '>
           <button className="absolute sm:text-5xl top-[40%] right-0 text-2xl hover:text-blue-200
           hover:scale-[1.15] transition-all" onClick={nextTestimonial} />
            <button className="absolute top-[40%] left-0 text-2xl
            hover:text-blue-200
