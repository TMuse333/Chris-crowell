...
import { experienceCardData, imageTextBoxData } from "@/data/homepageData";
...
const ExperienceSection = () => {
  ...
  return (
    <div ref={wrapperRef} className="relative w-full h-[200vh] md:h-[150vh]">
      ...
      <div
        ref={containerRef}
        className="absolute top-[100vh] w-screen h-[150vh] bg-gray-300 p-6 text-black rounded-2xl shadow-lg"
      >
