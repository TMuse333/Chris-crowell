...
const PodcastGrid = () => {
    ...
    return (
       ...
       />
       <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Totam, excepturi? Cum temporibus ullam voluptates dolorem, consequuntur voluptate animi harum minima eum maxime, mollitia corrupti porro.</p>
