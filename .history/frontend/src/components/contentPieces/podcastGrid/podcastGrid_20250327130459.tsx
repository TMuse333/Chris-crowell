...
const PodcastGrid = () => {
    ...
    return (
      ...
      px-3 relative transition-colors"
       ...
       >We have had the opportunity to sit down with incredible guests and dive into fascinating discussions on a variety of topics. 
       From expert insights to thought-provoking conversations, these are some of the standout episodes we’ve produced. 
