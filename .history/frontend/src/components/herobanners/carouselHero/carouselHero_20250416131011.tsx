...
const Carousel: React.FC<CarouselProps> = ({ images }) => {
  ...
  return (
    ...
    >
      <section className="w-full h-full max-w-[600px] relative
      mx-auto bg-transparent z-[2]">
      ...
      <button
        onClick={handleNext}
        className="absolute right-0 top-1/2 transform -translate-y-1/2 text-white text-4xl z-10 hover:scale-110 transition"
