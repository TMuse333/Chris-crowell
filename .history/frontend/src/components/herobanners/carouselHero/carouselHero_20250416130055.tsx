    ...
    >
      ...
      <div className="absolute flex bottom-[5%] left-1/2 -translate-x-1/2">
        {images.map((_, index) => (
          <div
            key={index}
            className={`h-[8px] relative w-[50px] bg-gray-600 mr-3 hover:scale-[1.2] transition-all cursor-pointer`}
      ...
      <button
        ...
        className="absolute bottom-[10%] left-1/2 transform -translate-x-1/2 text-white text-xl px-4 py-2 bg-gray-700 rounded-full hover:bg-gray-600 transition"
