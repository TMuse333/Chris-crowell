...
import TypeAlongText from "../textAnimations/typeAlongText";
import FadeInFromLeftText from "@/components/textAnimations/fadeInFromLeftText/fadeInFromLeftText";
import team from "../../../public/botox1.jpeg";
import advisors from "../../../public/botox2.jpeg";
import assistants from "../../../public/botox3.jpeg";
    ...
    >
      <section className="flex flex-col md:w-[40vw] justify-center items-center py-4">
        ...
        <section className="flex mt-4 mr-auto ml-4 w-full ">
          <button className="rounded-2xl p-3 bg-button-color">
            {buttonText}
          </button>
        </section>
      </section>
