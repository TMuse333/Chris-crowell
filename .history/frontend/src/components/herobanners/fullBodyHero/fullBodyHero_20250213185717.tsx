...
>
 ...
 relative z-[4] bg-transparent mt-[-6.5rem]
   ...
   h-[80vh] w-[50vw] flex flex-col
   items-end bg-red-200
          ...
          initial={{y:30,
            ...
            width={1300}
            alt='A full body image of Thomas Musial'
            className="hidden w-[98vw] md:w-[55vw]  rounded-2xl  object-contain mx-auto
 bg-gray-300  md:block  bg-transparent h-[80%]
 relative z-[3]  mt-auto absolute bottom-0
            ...
            />
            {/* <div className="
            bg-gradient-to-b from-[#2EC9FF] to-[#0099cc]
            h-[20%]
            w-full">
