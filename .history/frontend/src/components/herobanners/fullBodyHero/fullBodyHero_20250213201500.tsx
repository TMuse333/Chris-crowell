...
>
 ...
 relative z-[4] bg-transparent mt-[-6.5rem]
         ...
         <motion.div
  className="relative z-[3] mt-auto h-[80vh] w-[50vw] bg-red-200 flex flex-col justify-end"
...
>
  <Image
    ...
    width={1300}
    alt="A full body image of Thomas Musial"
    className="w-[98vw] md:w-[55vw] rounded-2xl object-contain mx-auto bg-gray-300 bg-transparent h-auto relative z-[3] mt-auto"
  />
</motion.div>
