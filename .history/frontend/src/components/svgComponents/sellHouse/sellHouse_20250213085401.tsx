...
const SellHouse = () => {
  ...
  const handleClick = () => {
    setGradientColor((prevColor) => (prevColor === "#008000" ? "#006400" : "#008000"));
  };

  return (
    <section className="w-[40vw] flex justify-center items-center h-screen">
      <div onClick={handleClick} className="cursor-pointer">
        ...
        >
          ...
          <g>
            ...
            <path d={DOLLAR_SIGN_PATH} fill="black" />
          </g>
        </svg>
      </div>
