...
const HouseSvg:React.FC<Props> = ({
  ...
  return (
    ...
    absolute top-1/2 -translate-y-1/2 left-[${isClicked ? '50%' : "50%"}]  flex justify-center items-center 
    `}
    ...
    >
        ...
        <HouseIcon
          style={{ fill: !hovered ? "#010101" : "#00bfff" }} // Use the state to dynamically change color
