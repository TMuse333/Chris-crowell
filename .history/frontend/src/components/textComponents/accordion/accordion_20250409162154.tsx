...
const Accordion: React.FC<Props> = ({
  ...
  const elementsPerPage = 6; // Show 6 elements per page
      ...
      >
        ...
        >
          <div className="flex flex-col">
            ...
            <div className="h-[calc(6*5rem)] space-y-2">
                  ...
                  {currentElements.map((item, index: number) => (
                    ...
                    >
                      ...
                      <motion.h2
                        ...
                        className="mb-3 mx-auto pl-4 text-center font-semibold text-lg sm:text-xl md:text-2xl text-gray-800"
                      >
                        {item.title}
                      </motion.h2>
                      <p
                        className={`duration-500 text-left w-[50%] pl-5 pr-5 rounded-md sm:w-[100%] max-w-[500px] text-gray-600
                        ${
                          expandedIndex === startIndex + index
