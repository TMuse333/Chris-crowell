...
const Accordion: React.FC<Props> = ({
  ...
  const elementsPerPage = 3; // Show 3 elements per page (reduced from 6)
                  ...
                  {currentElements.map((item, index: number) => (
                    ...
                    >
                      ...
                      <motion.h2
                        ...
                        className="mb-3 pl-4 text-left font-semibold text-lg sm:text-xl md:text-2xl text-gray-800" // Changed to text-left
                      >
                        {item.title}
                      </motion.h2>
                      <p
                        className={`duration-500 text-left w-[90%] pl-5 pr-5 rounded-md sm:w-[90%] max-w-[800px] text-gray-600
