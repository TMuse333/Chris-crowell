...
text-3xl sm:text-4xl md:text-5xl font-semibold text-center relative transition-colors"
  ...
  md:text-lg"
  >
Hear from my satisfied clients who have experienced first-hand the dedication and expertise I bring as a real estate agent in Nova Scotia. From smooth transactions to exceptional service, their stories highlight the impact of working with a trusted professional!
<br/>
<a
...
>
  <button className="rounded-2xl bg-[#00bfff] p-2 mt-2">
    See all reviews
  </button>
</a>
  </motion.p>
