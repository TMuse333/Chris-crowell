...
<Image
        ...
        width={600}
        height={1300}
        className="w-[10vw] ml-10 object-contain mx-auto max-w-[150px]"
      />
</div>
...
while keeping all the same data, rearrange the footer in a different format that looks more organized and appealing