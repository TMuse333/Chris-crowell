  ...
  return (
    <div className="relative w-full h-full">
      ...
      <motion.div
        ...
        className="sm:clip-path-[polygon(100%_0,_0_100%,_100%_100%)] md:clip-path-[polygon(100%_0,_99%_50%,_100%_100%)]"
      />
      ...
      <motion.div
        ...
        initial={{
          clipPath: "polygon(55% 0, 0 0, 0 38%)", // Start as a thin line
        }}
        animate={{
          clipPath: "polygon(55% 0, 0 0, 0 38%)", // Same animation for the second polygon
        }}
        transition={{
          duration: 1.5,
          ease: "easeInOut",
        ...
        // For mobile: Apply larger polygon, for md and above: apply the original polygon
        className="sm:clip-path-[polygon(55%_0,_0_0,_0_38%)] md:clip-path-[polygon(55%_0,_0_0,_0_38%)]"
      />
    </div>
  );
};
