...
<h3 className={`text-xl sm:text-2xl md:text-3xl font-semibold mt-6 md:px-6 text-center mx-auto ${boxTextColor ? `${boxTextColor}` : ''}`}>
  {title}
</h3>
...
{steps.map((step, index) => {
  ...
  return (
    <motion.div
      key={index}
      className={`relative z-10 px-4 max-w-[350px]
      ${boxTextColor ? `${boxTextColor}` : ''}
