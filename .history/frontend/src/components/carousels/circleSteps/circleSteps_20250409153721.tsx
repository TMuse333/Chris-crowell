...
const CircleStep = ({ number, title, description, inView, index,
  ...
  <h3 className="text-xl sm:text-2xl md:text-3xl font-semibold mt-6 md:px-6  text-center mx-auto">
    {title}
  </h3>

  <p className="text-sm sm:text-md md:text-lg text-center mt-2  mx-auto">
    {description}
  </p>
{/* </div> */}
</>
