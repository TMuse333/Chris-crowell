...
<AnimatePresence mode='wait'>
  ...
  />
            ...
            <div className={`${!carouselClicked || hasDescription ? `
              ...
              z-[45]`}
            >
              <button aria-label="Previous image" className='bg-transparent p-0 absolute left-0 top-[25%] md:top-[50%] text-black'>
                <ChevronLeft onClick={handlePrevClick} size={40} />
              </button>
              <button aria-label="Next image" className='bg-transparent p-0 absolute right-0 top-[25%] md:top-[50%] text-black'>
