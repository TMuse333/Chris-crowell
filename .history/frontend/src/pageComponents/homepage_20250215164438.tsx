...
import { carouselHeroData, closingStatement, contactData, experienceCardData, imageTextBoxData,imageTextBoxData2, lorem60, parallaxTextContentData, textAndListData } from "@/data/homepageData";
