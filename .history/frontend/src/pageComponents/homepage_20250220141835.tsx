...
const TextParallaxContentExample = dynamic(() => import("@/components/contentPieces/parallaxText/parallaxText"));
  ...
  return (
    <main className="w-screen bg-gradient-to-tr from-blue-200 to-blue-100">
      ...
      <section className="overflow-x-hidden">
        ...
        <ImageTextBox {...imageTextBoxData} reverse customImage={<HouseMoney />} />
