...
import { carouselHeroData,testimonials, closingStatement, contactData, experienceCardData, imageTextBoxData,imageTextBoxData2, lorem60, parallaxTextContentData, textAndListData } from "@/data/homepageData";
...
const Homepage = () => {
    ...
    return (
        <main className="overflow-x-hidden w-screen bg-gradient-to-tr from-blue-200 to-blue-100
  ">
           <BigNav
           excludedLink="Home"
           />
