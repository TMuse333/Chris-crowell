...
export const buyingHero: ThreeBoxHeroProps = {
    h1: "Buy a Home in Halifax, Nova Scotia",
    h2: "Find Your Ideal Property with Confidence",
    pTag:
    ...
    bgColor: "bg-gradient-to-br from-green-200 to-blue-100 via-green-100",
  };
