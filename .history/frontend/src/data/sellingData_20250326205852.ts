...
export const slideShowSellingData = [
  {
    title: 'Step 1: Preparing Your Home for Sale',
    src: "/sale.png",
    alt: "Preparing the home for sale",
    description: "Before listing your home, it's crucial to ensure it's in the best possible condition. This means staging your property to highlight its strengths, making necessary repairs, and possibly upgrading key areas to increase its value. A clean, well-maintained home will appeal to buyers and help you secure a higher sale price.",
    isVideo: false
  },
  {
    title: 'Step 2: Listing Your Home with a Realtor',
    src: "/listing.png",
    alt: "Listing the home with a realtor",
    description: "Partner with a local expert to list your home. A realtor will guide you through pricing, market trends, and preparing an effective marketing strategy. With their help, your property will get the exposure it needs across multiple platforms, attracting more potential buyers and maximizing your chances of selling quickly.",
    isVideo: false
  },
  {
    title: 'Step 3: Negotiating Offers on Your Home',
    src: "/negotiation2.png",
    alt: "Negotiating offers on the home",
    description: "Once you start receiving offers, it's time to carefully review them. Your realtor will assist you in negotiating terms, from the price to contingencies and timelines, ensuring you get the best possible deal. Effective negotiation skills are crucial to securing a sale that meets your goals and expectations.",
    isVideo: false
  },
  {
    title: 'Step 4: Closing the Deal on Your Home',
    src: "/close-deal.svg",
    alt: "Closing the deal on the home",
    description: "Once an offer is accepted, the closing process begins. This involves finalizing the sale through legal paperwork, including contracts and transfer of ownership. Your realtor will guide you through this process, ensuring everything is in order for a smooth closing. After the deal is done, you can confidently hand over the keys to the new owner.",
    isVideo: false
  }
];
