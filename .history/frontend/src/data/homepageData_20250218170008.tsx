...
export const testimonials = [
  {
    ...
    date:'A month ago',
    description:`My husband and I worked with Chris to purchase our first home together. We are quite particular and move quickly, Chris was so helpful and responsive, he was always there for everything we needed and as obstacles came up, he went over and above to help us through them.

    He has strong recommendations for partners to use as well, which helped us move quickly.
    
    It has been our pleasure working with Chris!`,
    src:'/place-holder.jpg'
  }
]
