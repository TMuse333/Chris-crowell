...
{/* <motion.p
  className="p-6 font-semibold max-w-[600px] w-[50vw] mr-auto transition-all text-xl relative z-[2]"
  initial={{ y: 30, opacity: 0 }}
  animate={{ y:startFadeIn ? 0 : 30, opacity: startFadeIn ? 1 : 0 }}
  transition={{ duration: 0.6, ease: "easeOut" }}

  onAnimationComplete={setStartFullBody}
>
  Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maxime id nostrum sit deleniti dolores. Libero sed laborum exercitationem et porro veniam necessitatibus voluptatum autem a!
</motion.p>; */}
